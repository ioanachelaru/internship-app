...
from application.views import StudentViewSet, HrViewSet, CompanyViewSet, AnnouncementViewSet, Job_applViewSet, AnnouncementDetail
...
router.register('applications', Job_applViewSet, 'applications')
